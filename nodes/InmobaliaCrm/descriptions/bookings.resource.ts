...
export const bookingsOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'Get by Code', value: 'getByCode', action: 'Get by code', description: 'Get a booking by code' },
			{ name: 'Get Check-In Event', value: 'getCheckIn', action: 'Get check in event', description: 'Get a booking\'s check-in event' },
			{ name: 'Get Check-Out Event', value: 'getCheckOut', action: 'Get check out event', description: 'Get a booking\'s check-out event' },
			{ name: 'List', value: 'list', action: 'List bookings', description: 'List bookings (paginated)' },
			{ name: 'List by Contact', value: 'listByContact', action: 'List by contact', description: 'List bookings by contact ID' },
			{ name: 'List by Property', value: 'listByProperty', action: 'List by property', description: 'List bookings by property ID' },
		],
		default: 'list',
	},
]
