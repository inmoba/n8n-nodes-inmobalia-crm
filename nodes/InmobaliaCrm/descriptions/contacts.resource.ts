...
export const contactsOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				name: 'List Additional Addresses',
				value: 'listAdditionals',
				action: 'List additional addresses',
			...
			},
			{
				...
				value: 'listFiles',
				action: 'List files',
				description: 'List files for a contact',
			},
			{
				name: 'List Lead Status',
				value: 'listLeadStatus',
				action: 'List lead statuses',
				description: 'List all contact lead statuses',
			},
			{
				name: 'List Sources',
				value: 'listSources',
				action: 'List sources',
				description: 'List all contact sources',
			},
			{
				name: 'List Tags',
				value: 'listTags',
